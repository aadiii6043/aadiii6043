...
---
![visitors](https://vbr.nathanchung.dev/badge?page_id=aadiii6043.aadiii6043&color=00cf00)


# <img src="https://emojis.slackmojis.com/emojis/images/1531849430/4246/blob-sunglasses.gif?1531849430" width="27"/> 𝗜'𝗺 𝗔𝗱𝗶𝘁𝘆𝗮 ✨

<table>
  <tr>
    <td style="vertical-align: top; width: 70%;">
      <h3>💻 I'm a passionate <strong>Software Developer</strong></h3>
      <p>Currently working at Cognizant Technology Solution on innovative projects.</p>
      <h3>🤖 Currently learning <strong>AI & Deep Learning</strong></h3>
      <p>Exploring Artificial Intelligence and Machine Learning applications.</p>
      <h3>🌐 Open to <strong>collaborations</strong></h3>
      <p>Excited to work on AI/ML Projects and creative development initiatives.</p>
    </td>
...
<p align="left">
  ...
  <a href="mailto:adityaraj6043@gmail.com" target="_blank">
    <img src="./gmail.png" width="40" height="40" alt="Email" />
  </a>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

  <a href="https://www.instagram.com/aadiiiofficial/" target="_blank">
    <img src="./instagram.png" width="40" height="40" alt="Instagram" />
  </a>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

  <a href="https://github.com/aadiii6043" target="_blank">
    <img src="./github.png" width="40" height="40" alt="GitHub" />
  </a>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

  <a href="https://www.linkedin.com/in/aditya-raj-10a944225/" target="_blank">
...
<ul align="left">
  ...
  <li>⚛️ <strong>Python & Programming</strong><br>Backend development, scripting, and automation.</li><br>

  <li>📊 <strong>Data Analysis</strong><br>Data processing and visualization with popular libraries.</li><br>

  <li>🧠 <strong>Deep Learning</strong><br>Model building using TensorFlow and PyTorch.</li><br>

  <li>🛠️ <strong>DevOps & Tools</strong><br>Git, GitHub, and development best practices.</li>
</ul>
  ...
  <table style="width: 100%; max-width: 1000px; border-collapse: collapse; border: 2px solid #444; text-align: center;">
    ...
    <tbody>
      ...
      <tr style="background-color: #f2f2f2;">
        ...
        <th style="border: 1px solid #ccc; padding: 10px;">📝 Community & Learning</th>
